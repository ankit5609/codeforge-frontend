...
export default function ResetPassword() {
  ...
  return (
    <AuthLayout
      ...
      description="Create a new secure password to regain access to your workspace. Your reset link is valid for 15 minutes and can only be used once."
      badges={["one-time use", "15 minute window", "encrypted at rest"]}
    >
      <AuthCard>
        {tokenMissing ? (
          ...
          <>
            <form onSubmit={handleSubmit} className="space-y-[16px]">
              ...
              {fieldError && (
                <p className="text-[12px]" style={{ color: "#ff7a5c" }}>
                  {fieldError}
                </p>
              )}
