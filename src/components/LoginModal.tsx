...
export function LoginModal() {
  ...
  return (
    <AuthLayout
      ...
      description="Your projects, chats, and sandboxes are exactly as you left them."
      badges={["session encrypted", "isolated k8s sandboxes", "back in seconds"]}
    >
      <AuthCard>
        <form onSubmit={handleSubmit} className="space-y-[16px]">
          ...
          <div className="flex items-center justify-between pt-1">
            <label className="flex items-center gap-2 cursor-pointer select-none group">
              ...
              >
                {remember && (
                  <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#160800" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
...
export function FieldShell({ icon, children }: { icon: React.ReactNode; children: React.ReactNode }) {
  return (
...
export function SolidButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="lp-auth-btn lp-auth-btn--solid mt-1"
    >
      {children}
    </button>
  );
...
export function OutlineButton({
  ...
  return (
    <button type="button" onClick={onClick} disabled={disabled} className="lp-auth-btn lp-auth-btn--outline">
      {children}
    </button>
  );
}
...
export function QuietButton({
  ...
  return (
    <button type="button" onClick={onClick} disabled={disabled} className="lp-auth-btn lp-auth-btn--quiet">
      {children}
    </button>
  );
}
  ...
  return (
    <div className="flex items-center gap-3.5 my-5">
      ...
      <span
        ...
        style={{ fontSize: "10.5px", letterSpacing: "0.14em", color: "var(--lp-ink-faint)" }}
      >
        or
      </span>
      <span className="flex-1 h-px" style={{ background: "var(--lp-border-soft)" }} />
