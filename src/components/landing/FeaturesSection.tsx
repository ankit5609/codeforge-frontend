...
const FeaturesSection = () => (
  <section id="workspace" className="lp-section">
    <div className="lp-container">
      <SectionHeader
        eyebrow="// The workspace"
        title={<>Everything a build needs.<br />Nothing it doesn't.</>}
        subtitle="Six things you'll actually use, not a feature list padded for the pricing table."
      />
