...
export function SubscriptionBanner({ message, onUpgrade }) {
    return (<motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease: [0.16, 0.8, 0.3, 1] }} className="flex items-start gap-4 rounded-[16px] p-5" style={{
